...
/*
  OLED_ShowString(0,0,"UNICORN_LI",16, 1);    //反相显示8X16字符�???????????????????
   OLED_ShowString(0,2,"unicorn_li_123",12,0);//正相显示6X8字符�???????????????????
   ...
   OLED_ShowNum(48,4,6,1,16, 0);//正相显示1�???????????????????8X16数字�???????????????????6�???????????????????
   OLED_ShowNum(48,7,77,2,12, 1);//反相显示2�???????????????????6X8数字�???????????????????77�???????????????????
